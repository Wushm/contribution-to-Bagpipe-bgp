...
class VPNManager(LookingGlass):
    ...
    def plugVifToVPN(self, externalInstanceId, instanceType, importRTs,
                     ...
                     localPort, linuxbr, advertiseSubnet, readvertise, vnid):
        ...
        try:
            ...
            if instanceType == "evpn" and linuxbr:
                ...
                kwargs = {}
	    if not vnid:  # if vnid is not specified by the cli then use the labelAllocator
	            vpnInstance = vpnInstanceFactory(
        	        self.bgpManager, self.labelAllocator, vnid, dataplaneDriver,
